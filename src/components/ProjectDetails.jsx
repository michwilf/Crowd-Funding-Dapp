  ...
  return (
      <div className="py-24 px-6 flex justify-center">
          <div className="flex justify-center flex-col md:w-2/3">
              ...
              <img src={project?.imageURL} alt={project?.title} className="rounded-xl h-64 w-full object-cover sm:w-1/3 mb-0 sm:mb-2" />
              <div className="flex-1 sm:py-0 py-4">
                  <div className="flex flex-col justify-start flex-wrap ">
                      ...
                      <div className="flex justify-between items-center w-full pt-1">
                          <div className="lex justify-start space-x-2">
              ...
              <div className="flex justify-start items-center space-x-2 mt-4">
                  {project?.status == 0 ? (
          <button type='button' className='inline-block px-6 py-2.5 rounded-full bg-green-500 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-green-700' onClick={() => setGlobalState('backModal', 'scale-100')}>Back Project</button>
                      ) : null}
